...
#define NODE_MAIN_LOGGER_NAME "planner_manager_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libplanner_manager.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fast_planner::kino_replan_fsm>";
